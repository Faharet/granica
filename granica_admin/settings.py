...
MIDDLEWARE = [
    ...
    'platform_manager.middleware.RestrictAdminAccessMiddleware',
...
# MinIO storage (commented out for faster local development)
...
# Use local filesystem storage (much faster)
STORAGES = {
    "default": {
